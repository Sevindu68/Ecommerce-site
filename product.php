    ...
    if(isset($user_id))
        if($_SESSION['isAdmin']==='Yes'){
            ...
            if (mysqli_num_rows($check)) {
                ...
                $add_to_cart_sql = "INSERT INTO cart (user_id, product_id,product_count) VALUES ('$user_id', '$product_id','1')";
...
<body>
    ...
    <section class="popular " id="popular2">
        ...
        ?>
        <h1 class="heading" ><?php echo $row['brand_name'] ?> <span> spare parts</span> </h1>
                ...
                if (mysqli_num_rows($result)) {
                    ...
                    <div class="box">
                        ...
                        <div class="box2">
                            ...
                            echo'
                            <form method="post">
                                <button   name="wishlist-btn" class="cart" style="width:50px; height:50px;"><i class="fa-solid fa-heart"></i> </button>
                                <span class="price">Rs'.$row["price"].' </span>
                                <button  name="addCart-btn" class="cart" style="width:50px; height:50px;"><i class="fa-solid fa-cart-shopping"></i></button>
